...
/* 0, 1: 定时器0用做定时器, 12T / T; 2: 定时器0用做计数器	*/
...
#define 	Timer0_Run( n )					( n == ?( TR0 = 0 ):( TR0 = 1 ))				/* 定时器0计数使能 */
...
/* 0, 1: 定时器1用做定时器, 12T / T; 2: 定时器1用做计数器	*/
...
#define 	Timer1_Run( n )					( n == ?( TR1 = 0 ):( TR1 = 1 ))				/* 定时器1计数使能 */
...
/* 0, 1: 定时器2用做定时器, 12T / T; 2: 定时器2用做计数器	*/
...
#define 	Timer2_Run( n )					( n == ?( T2R = 0 ):( T2R = 1 ))		/* 定时器2计数使能 */
...
/* 0, 1: 定时器3用做定时器, 12T / T; 2: 定时器3用做计数器	*/
...
#define 	Timer3_Run( n )					( n == ?( T3R = 0 ):( T3R = 1 ))	/* 定时器3计数使能 */
...
/* 0, 1: 定时器4用做定时器, 12T / T; 2: 定时器4用做计数器	*/
...
#define 	Timer4_Run( n )					( n == ?( T4R = 0 ):( T4R = 1 ))	/* 定时器4计数使能 */
