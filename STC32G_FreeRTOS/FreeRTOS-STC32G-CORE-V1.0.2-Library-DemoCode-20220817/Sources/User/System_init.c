...
//	NVIC_Timer0_Init( ENABLE, Priority_0 );		//中断使能, ENABLE / ISABLE; 优先级(低到高) Priority_0, Priority_1, Priority_2, Priority_3
...
//	NVIC_Timer1_Init( ENABLE, Priority_0 );		//中断使能, ENABLE / ISABLE; 优先级(低到高) Priority_0, Priority_1, Priority_2, Priority_3
...
void ADC_config( void )
{
	...
	NVIC_ADC_Init( DISABLE, Priority_0 );		    //中断使能, ENABLE / ISABLE; 优先级(低到高) Priority_0, Priority_1, Priority_2, Priority_3
}
...
//	NVIC_UART1_Init( ENABLE, Priority_1 );		//中断使能, ENABLE / ISABLE; 优先级(低到高) Priority_0, Priority_1, Priority_2, Priority_3
...
//	COMx_InitStructure.UART_BRT_Use   = BRT_Timer2;			//选择波特率发生器, BRT_Timer2 (注意: 串口2固定使用BRT_Timer2, 所以不用选择)
	...
	NVIC_UART2_Init( ENABLE, Priority_1 );		//中断使能, ENABLE / ISABLE; 优先级(低到高) Priority_0, Priority_1, Priority_2, Priority_3
	...
	NVIC_UART3_Init( ENABLE, Priority_1 );		//中断使能, ENABLE / ISABLE; 优先级(低到高) Priority_0, Priority_1, Priority_2, Priority_3
}
...
//	I2C_InitStructure.I2C_Speed     = 16;					//总线速度=Fosc / /( Speed *  + ),      0~63
//	I2C_Init(&I2C_InitStructure );
//	NVIC_I2C_Init( I2C_Mode_Master, DISABLE, Priority_0 );		//主从模式, I2C_Mode_Master, I2C_Mode_Slave; 中断使能, ENABLE / ISABLE; 优先级(低到高) Priority_0, Priority_1, Priority_2, Priority_3
	...
	I2C_Init(&I2C_InitStructure );
	NVIC_I2C_Init( I2C_Mode_Slave, I2C_ESTAI|I2C_ERXI|I2C_ETXI|I2C_ESTOI, Priority_0 );	//主从模式, I2C_Mode_Master, I2C_Mode_Slave; 中断使能, I2C_ESTAI / 2C_ERXI / 2C_ETXI / 2C_ESTOI / ISABLE; 优先级(低到高) Priority_0, Priority_1, Priority_2, Priority_3
}
...
void SPI_config( void )
{
	...
	SPI_InitStructure.SPI_Speed     = SPI_Speed_4;			//SPI速度    SPI_Speed_4, SPI_Speed_8, SPI_Speed_16, SPI_Speed_32 / PI_Speed_2
	SPI_Init(&SPI_InitStructure );
	NVIC_SPI_Init( ENABLE, Priority_3 );		//中断使能, ENABLE / ISABLE; 优先级(低到高) Priority_0, Priority_1, Priority_2, Priority_3
}
...
void CMP_config( void )
{
	...
	CMP_InitStructure.CMP_P_Select     = CMP_P_P37;		//比较器输入正极选择, CMP_P_P37 / MP_P_P50 / MP_P_P51, CMP_P_ADC: 由ADC模拟输入端做正输入.
	...
	NVIC_CMP_Init( RISING_EDGE|FALLING_EDGE, Priority_0 );	//中断使能, RISING_EDGE / ALLING_EDGE / ISABLE; 优先级(低到高) Priority_0, Priority_1, Priority_2, Priority_3
}
//========================================================================
//                             外部中断初始化
//========================================================================
void Exti_config( void )
{
	...
	NVIC_INT0_Init( ENABLE, Priority_0 );		//中断使能, ENABLE / ISABLE; 优先级(低到高) Priority_0, Priority_1, Priority_2, Priority_3

	Exti_InitStructure.EXTI_Mode      = EXT_MODE_Fall;//中断模式,   EXT_MODE_RiseFall, EXT_MODE_Fall
	Ext_Inilize( EXT_INT1,&Exti_InitStructure );				//初始化
	NVIC_INT1_Init( ENABLE, Priority_0 );		//中断使能, ENABLE / ISABLE; 优先级(低到高) Priority_0, Priority_1, Priority_2, Priority_3

	NVIC_INT2_Init( ENABLE, 0 );		//中断使能, ENABLE / ISABLE; 无优先级
	NVIC_INT3_Init( ENABLE, 0 );		//中断使能, ENABLE / ISABLE; 无优先级
	NVIC_INT4_Init( ENABLE, 0 );		//中断使能, ENABLE / ISABLE; 无优先级
}
