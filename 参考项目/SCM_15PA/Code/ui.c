...
void uiRecd( unsigned char recd_num )
{
    ...
    if ( recd_num == 0x1 ){
        ...
        setSegData(1, 16 );
        setSegData(2, 10 );
        setSegData(3, frqMax > 10000   ? frqMax / 0000      :   10 );
        setSegData(4, frqMax > 1000    ? frqMax % 0000 / 000 :   10 );
        setSegData(5, frqMax > 100     ? frqMax % 000 / 00   :   10 );
        setSegData(6, frqMax > 10      ? frqMax % 00 / 0     :   10 );   
...
void uiFrq( void )
{
	...
	if ( frq_error_flag == 1 ){
		...
		setSegData(3, frq_adjust > 10000   ? frq_adjust / 0000      :   10 );
		setSegData(4, frq_adjust > 1000    ? frq_adjust % 0000 / 000 :   10 );
		setSegData(5, frq_adjust > 100     ? frq_adjust % 000 / 00   :   10 );
		setSegData(6, frq_adjust > 10      ? frq_adjust % 00 / 0     :   10 );   
