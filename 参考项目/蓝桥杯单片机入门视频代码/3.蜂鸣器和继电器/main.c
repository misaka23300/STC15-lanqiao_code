...
//0x06->1ﺻﻗ٨ﻲﻁﺿ٧ﻝ£،٢؛٩ﻱﺻﻗ٨ﻲ١ﻎﺗﺍ٩٢ﺯﻰﺱﺙ٥ﺅ£،~0000 0110 = 111 1001
...
//ﺗﻱﺁﺽ٩¬ﺛﺂﺫﺁﺩﺷﺗﺹ
void Seg_Show(){
	static u8 num = ;//8ﺧ؛ﺗﻱﺁﺽ٩¬£،٦ﺥﺟ،ﺩﺷﺗﺹ£،ﺃ؟ﺯ؛ﺿ¬ﺋﻏﺵﻕ¢٤٨ﺃﻑﺥﺗﻱﺯ؛٤ﺧ
	
	P0 = xff;Y7;Y0;
	P0 = ei[num];Y6;Y0;//ﺣﻳ٣ﺓﺧ؛ﺭ­
...
void main(){
	...
	u8 state = ;
	P0 = xff;Y4;Y0;
	P0 = xaf;Y5;Y0;//P06, P04,٣ﻰﺗﺱ؛ﺥﺗ١ﺻﻗﺀﺵ٨ﻲﺓﻭ١٨ﺑﺙ٢؟٩ﻅ١ﺻ£،1010 1111 = 0xaf
	P0 = xff;Y6;Y0;//ﺧ؛ﺭ­1111 1111, com؟ﻏﺑﺙﺭ­£،P0 = x00
	P0 = xff;Y7;Y0;//٦ﺧﺭ­1111 1111,ﺛﻵﺳﺫﺗﻱﺁﺽ٩¬٩ﻅ
	...
	while (1 ){
		...
		Seg_Set(16, 16, 16, 16, 16, 16, sec / 0, sec٪10 );
		Seg_Show();
		Delay(1 );//1msﺭﺳﺗ١
		cnt++;
