...
0xc0, 0xf9, 0xa4, 0xb0, 0x99, 0x92, 0x82, 0xf8, 0x80, 0x90,  //0 - 
0xbf, 0xff,
0x40, 0x79, 0x24, 0x30, 0x19, 0x12, 0x02, 0x78, 0x00, 0x10
};
//ﭘﺿﺽ۵ﻉﺧ0 - ﭦﺱ-ﺗﺎ11ﺕﺉﻉﻅﺓﻳﺙﺽﺭﺵﺫ،ﺣﻭ
...
uint SMG_temp = ;   //2 16   5     1 3. 0 5   1.05C   0105
void main()
{
	Read_temp();
	Delay750ms();
	...
	while (1 )
	{
		if ( Read_Delay == 00 )SMG_temp = ead_temp()*100;
		SMGa[0] = 11;
		SMGa[1] = 11;
		SMGa[2] = 11;
		SMGa[3] = 11;
		if ( SMG_temp >= 000 )SMGa[4] = SMG_temp / 000 % 0;
		else SMGa[4] = 11;
		SMGa[5] = SMG_temp / 00 % 0 + 2;
		SMGa[6] = SMG_temp / 0 % 0;
		SMGa[7] = SMG_temp % 0;
	}
}
