...
#define    PWM2_USE_P12P13()    PWMA_PS = ( PWMA_PS & ~0x0C )          /* PWM ͨ 2 лP12 / 54( PWM2P ) P13( PWM2N ) */ 
...
#define PWMA_OPMA( n )              ( n == ?( PWMA_CR1 |= 0x08 ):( PWMA_CR1 &= ~0x08 ))  //ģʽ 0ڷ¼ʱֹͣ1ڷһθ¼ʱ CEN λֹͣ
#define PWMA_URSA( n )              ( n == ?( PWMA_CR1 |= 0x04 ):( PWMA_CR1 &= ~0x04 ))  //Դ
#define PWMA_UDISA( n )              ( n == ?( PWMA_CR1 |= 0x02 ):( PWMA_CR1 &= ~0x02 ))  //ֹ 0£UEV¼1¼
//#define PWMA_CEN_Enable()          PWMA_CR1 |= 0x01    //1ʹܼ
#define PWMA_CEN_Disable()        PWMA_CR1 &= ~0x01    //0ֹ
#define PWMA_CEN_Enable( n )        ( n == ?( PWMA_CR1 |= 0x01 ):( PWMA_CR1 &= ~0x01 ))    //1ʹܼ
...
#define PWMB_OPMB( n )              ( n == ?( PWMB_CR1 |= 0x08 ):( PWMB_CR1 &= ~0x08 ))  //ģʽ 0ڷ¼ʱֹͣ1ڷһθ¼ʱ CEN λֹͣ
#define PWMB_URSB( n )              ( n == ?( PWMB_CR1 |= 0x04 ):( PWMB_CR1 &= ~0x04 ))  //Դ
#define PWMB_UDISB( n )              ( n == ?( PWMB_CR1 |= 0x02 ):( PWMB_CR1 &= ~0x02 ))  //ֹ 0£UEV¼1¼
//#define PWMB_CEN_Enable()          PWMB_CR1 |= 0x01    //1ʹܼ
#define PWMB_CEN_Disable()        PWMB_CR1 &= ~0x01    //0ֹ
#define PWMB_CEN_Enable( n )        ( n == ?( PWMB_CR1 |= 0x01 ):( PWMB_CR1 &= ~0x01 ))    //1ʹܼ
...
//0 CCPC =  ʱֻ COMG λ 1 ʱЩλű
//1 CCPC =  ʱֻ COMG λ 1  TRGI صʱЩλű
#define PWMA_COMSUpdateCtrl( n )    PWMA_CR2 = ( n == ?( PWMA_CR2 |= 0x04 ):( PWMA_CR2 &= ~0x04 ))  ///ȽϿλĸ¿ѡ
#define PWMB_COMSUpdateCtrl( n )    PWMB_CR2 = ( n == ?( PWMB_CR2 |= 0x04 ):( PWMB_CR2 &= ~0x04 ))  ///ȽϿλĸ¿ѡ
//0 CCIE CCINE CCiP CCiNP  OCIM λԤװص
//1 CCIE CCINE CCiP CCiNP  OCIM λԤװصģøλֻ COMGλ󱻸¡
#define PWMA_CCPCAPreloaded( n )    PWMA_CR2 = ( n == ?( PWMA_CR2 |= 0x01 ):( PWMA_CR2 &= ~0x01 ))  ///ȽԤװؿλ(λֻԾлͨ)
#define PWMB_CCPCBPreloaded( n )    PWMA_CR2 = ( n == ?( PWMA_CR2 |= 0x01 ):( PWMA_CR2 &= ~0x01 ))  ///ȽԤװؿλ(λֻԾлͨ)
...
#define PWMA_OC1_ReloadEnable( n )  ( n == ?( PWMA_CCMR1 |= 0x08 ):( PWMA_CCMR1 &= ~0x08 ))    // OC1PE ȽϵԤװع
#define PWMB_OC5_ReloadEnable( n )  ( n == ?( PWMB_CCMR1 |= 0x08 ):( PWMB_CCMR1 &= ~0x08 ))    // OC5PE ȽϵԤװع
...
#define PWMA_OC1_FastEnable( n )    ( n == ?( PWMA_CCMR1 |= 0x04 ):( PWMA_CCMR1 &= ~0x04 ))    //1 OC1FE ȽϿٹ
#define PWMB_OC5_FastEnable( n )    ( n == ?( PWMB_CCMR1 |= 0x04 ):( PWMB_CCMR1 &= ~0x04 ))    //1 OC5FE ȽϿٹ
...
#define CCAS_IUTPUT_TI1FP1    0x01    //룬IC1 / C2 / C3 / C4 ӳ TI1FP1 
#define CCAS_IUTPUT_TI2FP1    0x02    //룬IC1 / C2 / C3 / C4 ӳ TI2FP1 
#define CCAS_IUTPUT_TRC        0x03    //룬IC1 / C2 / C3 / C4 ӳ TRC 
#define CCBS_OUTPUT            0x00    //
#define CCBS_IUTPUT_TI5FP5    0x01    //룬IC5 / C6 / C7 / C8 ӳ TI5FP5 
#define CCBS_IUTPUT_TI6FP5    0x02    //룬IC5 / C6 / C7 / C8 ӳ TI6FP5 
#define CCBS_IUTPUT_TRC        0x03    //룬IC5 / C6 / C7 / C8 ӳ TRC 
...
#define PWMA_BrakeOutputEnable( n )        ( n == ?( PWMA_BKR |= 0x80 ):( PWMA_BKR &= ~0x80 ))    //1ʹ
#define PWMB_BrakeOutputEnable( n )        ( n == ?( PWMB_BKR |= 0x80 ):( PWMB_BKR &= ~0x80 ))    //1ʹ
...
#define PWMA_BrakeEnable( n )              ( n == ?( PWMA_BKR |= 0x10 ):( PWMA_BKR &= ~0x10 ))    //1ɲ
#define PWMB_BrakeEnable( n )              ( n == ?( PWMB_BKR |= 0x10 ):( PWMB_BKR &= ~0x10 ))    //1ɲ
...
//ģʽ¡ر״̬ѡ
#define PWMA_OSSRnEnable()              PWMA_BKR |= 0x08    //1 PWM ʱһ CCiE =   CCiNE = ȿ OC / CN ЧƽȻOC / CN ʹź=1
#define PWMA_OSSRnDisable()              PWMA_BKR &= ~0x08    //0 PWM ʱֹ OC / CN OC / CN ʹź=0
#define PWMB_OSSRnEnable()              PWMB_BKR |= 0x08    //1 PWM ʱһ CCiE =   CCiNE = ȿ OC / CN ЧƽȻOC / CN ʹź=1
#define PWMB_OSSRnDisable()              PWMB_BKR &= ~0x08    //0 PWM ʱֹ OC / CN OC / CN ʹź=0
//ģʽ¡ر״̬ѡ
#define PWMA_OSSInEnable()              PWMA_BKR |= 0x04    //1 PWM ʱһ CCiE =   CCiNE = OC / CN еƽȻ OC / CNʹź=1
#define PWMA_OSSInDisable()              PWMA_BKR &= ~0x04    //0 PWM ʱֹ OC / CN OC / CN ʹź=0
#define PWMB_OSSInEnable()              PWMB_BKR |= 0x04    //1 PWM ʱһ CCiE =   CCiNE = OC / CN еƽȻ OC / CNʹź=1
#define PWMB_OSSInDisable()              PWMB_BKR &= ~0x04    //0 PWM ʱֹ OC / CN OC / CN ʹź=0

#define PWMn_lock_L0      0    //Ĵд
#define PWMn_lock_L1      1    // 1д PWMn_BKR Ĵ BKEBKPAOE λPWMn_OISR Ĵ OISI λ
#define PWMn_lock_L2      2    // 2д 1 еĸλҲд CC λԼ OSSR / SSI λ
...
#define PWMA_OC1_OUT_0()          PWMA_OISR &= ~0x01  /*  MOE =  ʱ OC1N ʹܣһOC1 =  */
#define PWMA_OC1_OUT_1()          PWMA_OISR |= 0x01    /*  MOE =  ʱ OC1N ʹܣһOC1 =  */
#define PWMA_OC1N_OUT_0()          PWMA_OISR &= ~0x02  /*  MOE =  ʱһOC1N =  */
#define PWMA_OC1N_OUT_1()          PWMA_OISR |= 0x02    /*  MOE =  ʱһOC1N =  */
#define PWMA_OC2_OUT_0()          PWMA_OISR &= ~0x04  /*  MOE =  ʱ OC2N ʹܣһOC2 =  */
#define PWMA_OC2_OUT_1()          PWMA_OISR |= 0x04    /*  MOE =  ʱ OC2N ʹܣһOC2 =  */
#define PWMA_OC2N_OUT_0()          PWMA_OISR &= ~0x08  /*  MOE =  ʱһOC2N =  */
#define PWMA_OC2N_OUT_1()          PWMA_OISR |= 0x08    /*  MOE =  ʱһOC2N =  */
#define PWMA_OC3_OUT_0()          PWMA_OISR &= ~0x10  /*  MOE =  ʱ OC3N ʹܣһOC3 =  */
#define PWMA_OC3_OUT_1()          PWMA_OISR |= 0x10    /*  MOE =  ʱ OC3N ʹܣһOC3 =  */
#define PWMA_OC3N_OUT_0()          PWMA_OISR &= ~0x20  /*  MOE =  ʱһOC3N =  */
#define PWMA_OC3N_OUT_1()          PWMA_OISR |= 0x20    /*  MOE =  ʱһOC3N =  */
#define PWMA_OC4_OUT_0()          PWMA_OISR &= ~0x40  /*  MOE =  ʱ OC4N ʹܣһOC4 =  */
#define PWMA_OC4_OUT_1()          PWMA_OISR |= 0x40    /*  MOE =  ʱ OC4N ʹܣһOC4 =  */
#define PWMA_OC4N_OUT_0()          PWMA_OISR &= ~0x80  /*  MOE =  ʱһOC4N =  */
#define PWMA_OC4N_OUT_1()          PWMA_OISR |= 0x80    /*  MOE =  ʱһOC4N =  */

#define PWMB_OC5_OUT_0()          PWMB_OISR &= ~0x01  /*  MOE =  ʱһOC5 =  */
#define PWMB_OC5_OUT_1()          PWMB_OISR |= 0x01    /*  MOE =  ʱһOC5 =  */
#define PWMB_OC6_OUT_0()          PWMB_OISR &= ~0x04  /*  MOE =  ʱһOC6 =  */
#define PWMB_OC6_OUT_1()          PWMB_OISR |= 0x04    /*  MOE =  ʱһOC6 =  */
#define PWMB_OC7_OUT_0()          PWMB_OISR &= ~0x10  /*  MOE =  ʱһOC7 =  */
#define PWMB_OC7_OUT_1()          PWMB_OISR |= 0x10    /*  MOE =  ʱһOC7 =  */
#define PWMB_OC8_OUT_0()          PWMB_OISR &= ~0x40  /*  MOE =  ʱһOC8 =  */
#define PWMB_OC8_OUT_1()          PWMB_OISR |= 0x40    /*  MOE =  ʱһOC8 =  */
