...
#define 	Timer0_Run( n )					( n == ?( TR0 = 0 ):( TR0 = 1 ))				/* ʱ0ʹ */
...
#define 	Timer1_Run( n )					( n == ?( TR1 = 0 ):( TR1 = 1 ))				/* ʱ1ʹ */
...
#define 	Timer2_Run( n )					( n == ?( T2R = 0 ):( T2R = 1 ))		/* ʱ2ʹ */
...
#define 	Timer3_Run( n )					( n == ?( T3R = 0 ):( T3R = 1 ))	/* ʱ3ʹ */
...
#define 	Timer4_Run( n )					( n == ?( T4R = 0 ):( T4R = 1 ))	/* ʱ4ʹ */
