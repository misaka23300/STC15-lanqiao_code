...
#define		UART1_RxEnable( n )		( n == ?( REN = 0 ):( REN = 1 ))			/* UART1ʹ */
#define		UART2_RxEnable( n )		( n == ?( S2REN = 0 ):( S2REN = 1 ))		/* UART2ʹ */
#define		UART3_RxEnable( n )		( n == ?( S3REN = 0 ):( S3REN = 1 ))		/* UART3ʹ */
#define		UART4_RxEnable( n )		( n == ?( S4REN = 0 ):( S4REN = 1 ))		/* UART4ʹ */
