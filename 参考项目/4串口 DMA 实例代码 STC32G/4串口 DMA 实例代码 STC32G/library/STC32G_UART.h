...
#define	UART1	1       //Ê¹ÓÃÄÄÐ©´®¿Ú¾Í¿ª¶ÔÓ¦µÄ¶¨Òå£¬²»ÓÃµÄ´®¿Ú¿ÉÆÁ±Îµô¶¨Òå£¬½ÚÊ¡×ÊÔ´
#define	UART2	2
#define	UART3	3
#define	UART4	4

#define	UART_BUF_type	edata       //ÉèÖÃ´®¿ÚÊÕ·¢Êý¾Ý»º´æ¿Õ¼ä£¬¿ÉÑ¡ edata »òÕß xdata

#define	UART_QUEUE_MODE	0           //ÉèÖÃ´®¿Ú·¢ËÍÄ£Ê½£¬0£º×èÈûÄ£Ê½£¬1£º¶ÓÁÐÄ£Ê½

#define	PRINTF_SELECT  UART2		//Ñ¡Ôñ printf º¯ÊýËùÊ¹ÓÃµÄ´®¿Ú£¬²ÎÊý UART1~UART4

#ifdef UART1
#define	COM_TX1_Lenth	128         //ÉèÖÃ´®¿Ú1·¢ËÍÊý¾Ý»º³åÇø´óÐ¡
#define	COM_RX1_Lenth	128         //ÉèÖÃ´®¿Ú1½ÓÊÕÊý¾Ý»º³åÇø´óÐ¡
#endif
#ifdef UART2
#define	COM_TX2_Lenth	128         //ÉèÖÃ´®¿Ú2·¢ËÍÊý¾Ý»º³åÇø´óÐ¡
#define	COM_RX2_Lenth	128         //ÉèÖÃ´®¿Ú2½ÓÊÕÊý¾Ý»º³åÇø´óÐ¡
#endif
#ifdef UART3
#define	COM_TX3_Lenth	64          //ÉèÖÃ´®¿Ú3·¢ËÍÊý¾Ý»º³åÇø´óÐ¡
#define	COM_RX3_Lenth	64          //ÉèÖÃ´®¿Ú3½ÓÊÕÊý¾Ý»º³åÇø´óÐ¡
#endif
#ifdef UART4
#define	COM_TX4_Lenth	64          //ÉèÖÃ´®¿Ú4·¢ËÍÊý¾Ý»º³åÇø´óÐ¡
#define	COM_RX4_Lenth	64          //ÉèÖÃ´®¿Ú4½ÓÊÕÊý¾Ý»º³åÇø´óÐ¡
#endif

#define	UART_ShiftRight	0		//Í¬²½ÒÆÎ»Êä³ö
#define	UART_8bit_BRTx	(1<<6)	//8Î»Êý¾Ý,¿É±ä²¨ÌØÂÊ
#define	UART_9bit		(2<<6)	//9Î»Êý¾Ý,¹Ì¶¨²¨ÌØÂÊ
#define	UART_9bit_BRTx	(3<<6)	//9Î»Êý¾Ý,¿É±ä²¨ÌØÂÊ


#define	TimeOutSet1		5       //½ÓÊÕÊý¾Ý³¬Ê±Ê±¼äÉèÖÃ
...
#define		CLR_TI2()			S2TI = 0			/* Çå³ýTI2								 */
#define		CLR_RI2()			S2RI = 0			/* Çå³ýRI2								 */
#define		CLR_TI3()			S3TI = 0			/* Çå³ýTI3								 */
#define		CLR_RI3()			S3RI = 0			/* Çå³ýRI3								 */
#define		CLR_TI4()			S4TI = 0			/* Çå³ýTI3							     */
#define		CLR_RI4()			S4RI = 0			/* Çå³ýRI3							     */
...
{ 
	...
	u8	TX_write;		//·¢ËÍÐ´Ö¸Õë
	u8	B_TX_busy;		//Ã¦±êÖ¾

	u8 	RX_Cnt;			//½ÓÊÕ×Ö½Ú¼ÆÊý
	u8	RX_TimeOut;		//½ÓÊÕ³¬Ê±
} COMx_Define; 
...
{ 
	...
	u8	Morecommunicate;	//¶à»úÍ¨Ñ¶ÔÊÐí, ENABLE,DISABLE
	u8	UART_RxEnable;		//ÔÊÐí½ÓÊÕ,   ENABLE,DISABLE
