...
#define		I2C_Function( n )	( n == ?( I2CCFG &= ~0x80 ):( I2CCFG |= 0x80 ))	//0ֹ I2C ܣ1ʹ I2C 
...
#define		I2C_SetSpeed( n )	I2CCFG = ( I2CCFG & ~0x3f ) | ( n & 0x3f )	/* ٶ=Fosc / /( Speed *  + ) */
...
typedef struct
{
	u8	I2C_Speed;				//ٶ=Fosc / /( Speed *  + ),      0~63
