...
void UART1_ISR_Handler (void) interrupt UART1_VECTOR
{
	...
	if(TI)
	{
        ...
        #if(UART_QUEUE_MODE == 1)   //ÅÐ¶ÏÊÇ·ñÊ¹ÓÃ¶ÓÁÐÄ£Ê½
        ...
        #else
        COM1.B_TX_busy = 0;     //Ê¹ÓÃ×èÈû·½Ê½·¢ËÍÖ±½ÓÇå³ý·±Ã¦±êÖ¾
        #endif
	}
}
#endif
...
void UART2_ISR_Handler (void) interrupt UART2_VECTOR
{
	...
	if(S2TI)
	{
        ...
        #else
        COM2.B_TX_busy = 0;     //Ê¹ÓÃ×èÈû·½Ê½·¢ËÍÖ±½ÓÇå³ý·±Ã¦±êÖ¾
        #endif
	}
}
#endif
...
void UART3_ISR_Handler (void) interrupt UART3_VECTOR
{
	...
	if(S3TI)
	{
        ...
        #else
        COM3.B_TX_busy = 0;     //Ê¹ÓÃ×èÈû·½Ê½·¢ËÍÖ±½ÓÇå³ý·±Ã¦±êÖ¾
        #endif
	}
}
#endif
...
void UART4_ISR_Handler (void) interrupt UART4_VECTOR
{
	...
	if(S4TI)
	{
        ...
        #else
        COM4.B_TX_busy = 0;     //Ê¹ÓÃ×èÈû·½Ê½·¢ËÍÖ±½ÓÇå³ý·±Ã¦±êÖ¾
        #endif
	}
}
#endif
